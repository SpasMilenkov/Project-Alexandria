...
using Alexandria.Api.Features.Storage.Directories.UpdateDir;
...
public class UpdateDirectoryTests(AlexandriaFixture fixture) : FullStackTestBase(fixture)
{
    ...
    public async Task Rename_Returns200_WithNewName()
    {
        ...
        var response = await Auth.PatchAsJsonAsync($"{Route}/{dir.Id}", req,
    ...
    public async Task Unauthenticated_Returns401()
    {
        ...
        var response = await Anon.PatchAsJsonAsync($"{Route}/{dir.Id}", req,
            cancellationToken: TestContext.Current.CancellationToken);
    ...
    public async Task NonExistentDirectory_Returns4xx()
    {
        ...
        var response = await Auth.PatchAsJsonAsync($"{Route}/{nonExistentId}", req,
            cancellationToken: TestContext.Current.CancellationToken);
