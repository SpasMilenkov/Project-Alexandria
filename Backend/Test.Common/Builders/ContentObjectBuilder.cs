...
public class ContentObjectBuilder
{
    ...
    public ContentObjectBuilder WithId(Guid id) { _id = id; return this; }
    public ContentObjectBuilder WithHash(byte[] hash) { _hash = hash; return this; }
    ...
    public ContentObjectBuilder WithStorageKey(string storageKey) { _storageKey = storageKey; return this; }
    public ContentObjectBuilder WithIsPromoted(bool isPromoted) { _isPromoted = isPromoted; return this; }
    public ContentObjectBuilder WithPromotedAt(DateTime? promotedAt) { _promotedAt = promotedAt; return this; }
    public ContentObjectBuilder WithUpload(Guid? uploadId) { _uploadId = uploadId; return this; }
    public ContentObjectBuilder WithOrphanedAt(DateTime? orphanedAt) { _orphanedAt = orphanedAt; return this; }
    public ContentObjectBuilder WithCreatedAt(DateTime createdAt) { _createdAt = createdAt; return this; }
    public ContentObjectBuilder WithDeletedAt(DateTime? deletedAt) { _deletedAt = deletedAt; return this; }
