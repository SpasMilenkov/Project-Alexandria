...
public class UserSettingsRepository(AlexandriaDbContext context) : IUserSettingsRepository
{
    ...
    public async Task<UserSettings?> FirstOrDefaultAsync(Expression<Func<UserSettings, bool>> predicate,
    ...
    public async Task<IEnumerable<UserSettings>> FindAsync(Expression<Func<UserSettings, bool>> predicate,
        CancellationToken ct = default)
    {
    ...
    public async Task<IEnumerable<UserSettings>> AddRangeAsync(IEnumerable<UserSettings> entities,
        CancellationToken ct = default)
    {
    ...
    public async Task<int> CountAsync(Expression<Func<UserSettings, bool>>? predicate = null,
        CancellationToken ct = default)
    {
