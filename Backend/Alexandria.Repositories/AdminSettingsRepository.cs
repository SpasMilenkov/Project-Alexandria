...
public class AdminSettingsRepository(AlexandriaDbContext context) : IAdminSettingsRepository
{
    ...
    public async Task<AdminSettings?> FirstOrDefaultAsync(Expression<Func<AdminSettings, bool>> predicate,
    ...
    public async Task<IEnumerable<AdminSettings>> FindAsync(Expression<Func<AdminSettings, bool>> predicate,
        CancellationToken ct = default)
    {
    ...
    public async Task<IEnumerable<AdminSettings>> AddRangeAsync(IEnumerable<AdminSettings> entities,
        CancellationToken ct = default)
    {
    ...
    public async Task<int> CountAsync(Expression<Func<AdminSettings, bool>>? predicate = null,
        CancellationToken ct = default)
    {
