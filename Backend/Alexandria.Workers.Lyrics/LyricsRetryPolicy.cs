...
/// <summary>
/// Retry counting for lyrics deliveries. Plain requeue preserves the original
/// headers, so the count only moves when we republish the message ourselves
/// with an incremented <c>x-lyrics-attempts</c> header.
/// </summary>
internal static class LyricsRetryPolicy
{
    public const string AttemptsHeader = "x-lyrics-attempts";
