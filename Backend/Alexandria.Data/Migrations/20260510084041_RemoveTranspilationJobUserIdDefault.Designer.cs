...
namespace Alexandria.Data.Migrations
{
    ...
    [Migration("20260510084041_RemoveTranspilationJobUserIdDefault")]
    partial class RemoveTranspilationJobUserIdDefault
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Alexandria.Data.Models.TranspilationJob", b =>
                {
                    b.HasOne("Alexandria.Data.Models.ContentObject", "ContentObject")
                        .WithOne()
                        .HasForeignKey("Alexandria.Data.Models.TranspilationJob", "ContentObjectId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
