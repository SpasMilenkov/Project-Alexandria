...
namespace Alexandria.Data.Migrations
{
    ...
    [Migration("20260909164737_AutoPlaylistKinds")]
    partial class AutoPlaylistKinds
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Alexandria.Data.Models.Playlist", b =>
                {
                    ...
                    b.HasIndex("OwnerId", "AutoArtistKey")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 0");

                    b.HasIndex("OwnerId", "AutoDecade")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 5");

                    b.HasIndex("OwnerId", "AutoGenreKey")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 3");

                    b.HasIndex("OwnerId", "AutoTagId")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 4");

                    b.HasIndex("OwnerId", "AutoArtistKey", "AutoAlbumKey")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 1");
