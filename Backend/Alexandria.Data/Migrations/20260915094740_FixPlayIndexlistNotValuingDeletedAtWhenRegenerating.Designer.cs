...
namespace Alexandria.Data.Migrations
{
    ...
    [Migration("20260915094740_FixPlayIndexlistNotValuingDeletedAtWhenRegenerating")]
    partial class FixPlayIndexlistNotValuingDeletedAtWhenRegenerating
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Alexandria.Data.Models.OperationalEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("Alexandria.Data.Models.Playlist", b =>
                {
                    ...
                    b.Property<string>("AutoAlbumKey")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("AutoArtistKey")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");

                    b.Property<int?>("AutoDecade")
                        .HasColumnType("integer");

                    b.Property<string>("AutoGenreKey")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");

                    b.Property<int?>("AutoGroupKind")
                        .HasColumnType("integer");

                    b.Property<Guid?>("AutoTagId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("OwnerId", "AutoArtistKey")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 0 AND \"DeletedAt\" IS NULL");

                    b.HasIndex("OwnerId", "AutoDecade")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 5 AND \"DeletedAt\" IS NULL");

                    b.HasIndex("OwnerId", "AutoGenreKey")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 3 AND \"DeletedAt\" IS NULL");

                    b.HasIndex("OwnerId", "AutoArtistKey", "AutoAlbumKey")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" = 1 AND \"DeletedAt\" IS NULL");

                    b.HasIndex("OwnerId", "AutoGroupKind", "AutoTagId")
                        .IsUnique()
                        .HasFilter("\"IsAutoGenerated\" = TRUE AND \"AutoGroupKind\" IN (2, 4) AND \"DeletedAt\" IS NULL");
