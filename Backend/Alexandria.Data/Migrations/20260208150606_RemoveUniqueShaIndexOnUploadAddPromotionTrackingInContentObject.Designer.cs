...
namespace Alexandria.Data.Migrations
{
    ...
    [Migration("20260208150606_RemoveUniqueShaIndexOnUploadAddPromotionTrackingInContentObject")]
    partial class RemoveUniqueShaIndexOnUploadAddPromotionTrackingInContentObject
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Upload", b =>
                {
                    ...
                    b.ToTable("Uploads", null, t =>
                        {
                            t.HasCheckConstraint("CK_Upload_Sha256_Length", "octet_length(\"Sha256\") = 32");
                        });
                });
