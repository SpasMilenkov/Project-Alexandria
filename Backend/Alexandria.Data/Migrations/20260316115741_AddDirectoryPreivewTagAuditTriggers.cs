...
{
    /// <inheritdoc />
    public partial class AddDirectoryPreivewTagAuditTriggers : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            CREATE TRIGGER directories_audit_trigger
        ...
        ");
            ...
            // ----------------------------------------------------------------
            // FileVersion trigger
            // Versions are immutable once created — no rename/move events
            // ----------------------------------------------------------------
            migrationBuilder.Sql(@"
        ...
        ");
            ...
            // ----------------------------------------------------------------
            // Preview trigger
            // Previews are generated artifacts — no rename/move events
            // ----------------------------------------------------------------
            migrationBuilder.Sql(@"
            ...
            CREATE TRIGGER previews_audit_trigger
        ...
        ");
            ...
            // ----------------------------------------------------------------
            // Tag trigger
            // Tags can be renamed and have their appearance updated
            // ----------------------------------------------------------------
            migrationBuilder.Sql(@"
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    ELSIF TG_OP = 'UPDATE' THEN
                        ...
                        -- Rename takes priority as the primary event code
                        IF OLD.""Name"" IS DISTINCT FROM NEW.""Name"" THEN
                        ...
                        -- Appearance changes tracked together under TagUpdated
