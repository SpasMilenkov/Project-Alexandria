<template>
  ...
  <div class="flex min-h-screen">
    <!-- LEFT PANEL ( only) -->
    <aside
      class="relative hidden w-72 shrink-0 flex-col border-r border-gray-200/60 frosted-glass bg-gray-50/60 dark:border-gray-800/60 dark:bg-gray-900/40 lg:flex xl:w-80"
    >
