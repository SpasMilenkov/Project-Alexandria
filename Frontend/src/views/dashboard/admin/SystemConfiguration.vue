  ...
  <div class="min-h-screen px-6 py-10">
    ...
    <div class="max-w-4xl mx-auto">
      ...
      <UAlert
        color="neutral"
        variant="subtle"
        class="mb-8 border border-gray-200/70 dark:border-gray-700/70 bg-white/60 dark:bg-white/5 frosted-glass"
        :ui="{ root: 'rounded-xl' }"
      >
        <template #icon>
      ...
      <div class="grid gap-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div
            ...
            :key="section"
            class="rounded-2xl border border-dashed border-gray-200 dark:border-gray-700/60 frosted-glass bg-white/30 dark:bg-white/3 px-5 py-5 flex items-center gap-3"
          >
            <Icon
