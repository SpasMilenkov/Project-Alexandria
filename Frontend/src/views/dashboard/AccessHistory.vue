...
<template>
  <div class="flex flex-col h-full w-full flex-1">
    ...
    <div
      ...
      class="flex items-center justify-center px-6 py-2.5 border-b border-gray-200/70 dark:border-gray-700/70 bg-white/60 dark:bg-white/5 frosted-glass shrink-0"
    >
      <UPagination
