<template>
  ...
  >
    ...
    >
      <div class="relative w-full aspect-video">
        ...
        >
          <div
            v-if="!isAudioPlaying"
            class="flex items-center justify-center w-16 h-16 bg-white/30 frosted-glass rounded-full hover:bg-white/40 hover:scale-110 transition-all"
          >
      ...
      <div
        class="px-3 py-2 bg-neutral-100 dark:bg-neutral-900/50 frosted-glass border-t border-neutral-200 dark:border-neutral-800"
      >
        <div class="flex items-center gap-2">
          ...
          <UPopover :content="{ side: 'top' }" class="shrink-0">
            ...
            <template #content>
              <div
                class="flex flex-col items-center gap-2 p-3 bg-white/85 dark:bg-neutral-900/85 frosted-glass rounded-lg shadow-lg border border-neutral-200 dark:border-neutral-800"
              >
    ...
    <div
      ...
      class="relative xl:w-xl h-220 bg-white/85 dark:bg-neutral-900/85 frosted-glass rounded-lg overflow-hidden"
    >
    ...
    <div
      ...
      class="w-full p-6 bg-white/85 dark:bg-neutral-900/85 frosted-glass rounded-lg border border-gray-200 dark:border-gray-700"
    >
