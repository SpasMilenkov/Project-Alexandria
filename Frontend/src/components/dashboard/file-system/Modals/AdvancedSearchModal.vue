<template>
  ...
  >
          ...
          >
            <div class="p-4 sm:p-6 space-y-5">
              ...
              <fieldset class="space-y-3">
                <legend class="text-xs font-semibold uppercase tracking-wider text-muted mb-2">
                  General
                </legend>
                ...
                <UFormField label="Parent directory" name="parentDirectoryId" class="w-full">
                  <USelectMenu
                  ...
                  >
                    <template #default="{ modelValue }">
                      <span v-if="modelValue">
                        {{ parentDirData?.items.find((i) => i.id === modelValue)?.name }}
                      </span>
                ...
                <div class="flex flex-wrap gap-x-6 gap-y-2 pt-1">
                  <UFormField name="onlyDeleted">
                    <UCheckbox v-model="state.onlyDeleted" label="Only deleted" />
                  </UFormField>
              ...
              <fieldset v-if="searchMode !== 'directories'" class="space-y-3">
                ...
                <UFormField label="File extension" name="mime-type" class="w-full">
                  <USelectMenu
                    class="w-full"
              ...
              <fieldset v-if="searchMode !== 'files'" class="space-y-3">
                ...
                <div class="flex flex-wrap gap-x-6 gap-y-2">
                  ...
                  <UFormField name="has-subdirectories">
                    <UCheckbox v-model="state.hasSubdirectories" label="Has sub-directories" />
                  </UFormField>
                </div>
              </fieldset>
              <USeparator />
              ...
              <fieldset class="space-y-3">
                ...
                <div class="grid md:grid-cols-2 grid-cols-1 gap-3">
                  <UFormField label="Sort by" name="sort-by" class="w-full">
                    <USelect :items="sortByOptions" v-model="state.sortBy" class="w-full" />
                  </UFormField>
                  <UFormField label="Direction" name="sort-direction" class="w-full">
                    <USelect
                ...
                <UFormField label="Page size" name="page-size" class="w-full">
                  <USelect :items="pageSizeOptions" v-model="state.pageSize" class="w-full" />
                </UFormField>
              </fieldset>
              ...
              <UCollapsible>
                ...
                >
                  <span class="text-xs font-semibold uppercase tracking-wider">Date Filters</span>
                </UButton>
                ...
                <template #content>
                  <div class="space-y-3 pt-3">
                    ...
                    >
                      <UFormField label="Created after" name="createdAfter" class="w-full">
                        <!-- @vue-ignore -->
                        <UInputDate ref="createdAfter" v-model="state.createdAfter" class="w-full">
                          <template #trailing>
                      ...
                      <UFormField label="Created before" name="createdBefore" class="w-full">
                        <!-- @vue-ignore -->
                        <UInputDate
                          ref="createdBefore"
                      ...
                      <UFormField label="Updated after" name="updatedAfter" class="w-full">
                        <!-- @vue-ignore -->
                        <UInputDate ref="updatedAfter" v-model="state.updatedAfter" class="w-full">
                          <template #trailing>
                      ...
                      <UFormField label="Updated before" name="updatedBefore" class="w-full">
                        <!-- @vue-ignore -->
                        <UInputDate
                          ref="updatedBefore"
                      ...
                      <UFormField label="Deleted at" name="deletedBefore" class="w-full">
                        <!-- @vue-ignore -->
                        <UInputDate
                          ref="deletedBefore"
                      ...
                      <UFormField label="Deleted at" name="deletedAfter" class="w-full">
                        <!-- @vue-ignore -->
                        <UInputDate ref="deletedAfter" v-model="state.deletedAfter" class="w-full">
                          <template #trailing>
          ...
          <div class="flex-1 flex flex-col overflow-hidden min-h-0">
            ...
            >
              <div>
                ...
                <p v-if="hasSearched && !isSearching" class="text-xs text-muted mt-0.5">
                  {{ totalResultsText }}
                </p>
                <p v-else-if="isSearching" class="text-xs text-muted mt-0.5">Searching...</p>
                <p v-else class="text-xs text-muted mt-0.5">Configure filters and search</p>
              </div>
              <UButton
                v-if="hasResults"
                size="xs"
            ...
            <div class="flex-1 overflow-y-auto">
              ...
              >
                ...
                <p class="text-xs text-muted max-w-xs">
                  Configure your search parameters, then click Search to find matching items.
                </p>
              </div>
              ...
              >
                ...
                <p class="text-xs text-muted max-w-xs mb-4">
                  No items match your current search criteria. Try adjusting the filters.
                </p>
                <UButton
                  size="sm"
                  color="primary"
    ...
    <template #footer>
      <div class="flex flex-col-reverse sm:flex-row justify-between w-full gap-2">
        <UButton
          color="neutral"
          variant="ghost"
