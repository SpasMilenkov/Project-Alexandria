  ...
  <div ref="wrapperRef" class="relative">
    ...
    >
      <div
        ...
        class="absolute left-0 right-0 top-full mt-1.5 z-50 rounded-xl border border-black/[0.07] dark:border-white/[0.08] frosted-glass glass-surface-strong shadow-lg shadow-black/[0.08] dark:shadow-black/30 overflow-hidden"
      >
        <!-- Loading -->
