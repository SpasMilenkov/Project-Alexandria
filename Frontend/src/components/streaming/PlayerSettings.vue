    ...
    <Teleport to="body">
      <Transition name="settings-panel">
        <div
          ...
          class="player-card bg-white/85 dark:bg-neutral-900/85 frosted-glass border border-black/[0.08] dark:border-white/10 rounded-2xl shadow-2xl overflow-hidden flex flex-col"
          :style="panelStyle"
        >
          <!-- Quality -->
          <div class="p-4 pb-3">
